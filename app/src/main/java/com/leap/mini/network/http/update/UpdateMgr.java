...
import com.leap.mini.network.interactors.update.usecase.CheckVersionCase;
...
public class UpdateMgr {
  ...
  public static String UPDATE_INTENT = "updateModel";
  ...
  private void showDialog(boolean already, long position) {
    ...
    updateDialog = new UpdateDialog(context, R.style.FullScreenDialog);
