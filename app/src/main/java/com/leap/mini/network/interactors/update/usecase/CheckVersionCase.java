package com.leap.mini.network.interactors.update.usecase;

import com.leap.mini.network.http.bean.Response;
import com.leap.mini.network.interactors.update.UpdateServiceApi;
import com.leap.mini.network.http.BaseUseCase;
