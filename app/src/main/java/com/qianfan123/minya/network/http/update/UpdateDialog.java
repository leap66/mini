package com.qianfan123.minya.network.http.update;

import static com.qianfan123.minya.network.http.update.UpdateMgr.getScreenHeight;
import static com.qianfan123.minya.network.http.update.UpdateMgr.getScreenWidth;
...
public class UpdateDialog extends Dialog {
  ...
  private void initView(Context context) {
    ...
    RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(getScreenWidth() * 11 / 15,
            getScreenHeight() * 1 / 2);
