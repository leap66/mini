package com.qianfan123.minya.network.interactors.notify;

import java.util.List;

import com.qianfan123.minya.network.http.bean.QueryParam;
import com.qianfan123.minya.network.http.bean.Response;
import com.qianfan123.minya.network.model.notify.Notify;
